...
describe("MerkleTreeTest", () => {
    ...
    describe("create merkle tree and verify merkle proof of inclusion", () => {
        ...
        it("Block 700003", () => {
            ...
            const proof = instance.getInclusionProof(txs[100]);
            console.log(proof.hashes);
            console.log("Proof for ", Buffer.from(txs[100], "hex").reverse().toString("hex"), proof.hashes.filter((val, index) => (index != 0)).map((hash) => {
